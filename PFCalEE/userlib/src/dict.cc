//
// File generated by rootcint at Fri Jun 26 14:24:38 2015
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSInfo*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSEvent*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSSamplingSection*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSSimHit*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSGenParticle*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSRecoHit*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSRecoJet*)0x0)->GetClass();} }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSCluster*)0x0)->GetClass();} }
   return fgIsA;
}
